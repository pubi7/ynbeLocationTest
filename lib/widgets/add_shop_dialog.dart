...
class _AddShopDialogState extends State<AddShopDialog> {
    ...
    setState(() {
      ...
      if (registrationResult != null) {
        ...
        if (registrationResult.containsKey('error')) {
          ...
          _shopRegistrationError = registrationResult['message'] ??
              'Алдаа гарлаа. Гараар мэдээлэл оруулж болно.';
          _shopRegistrationInfo = null;
        } else {
        ...
        _shopRegistrationError =
            'API-аас мэдээлэл олдсонгүй. Гараар мэдээлэл оруулж болно.';
        _shopRegistrationInfo = null;
      }
    });
  }
  ...
  void _addShop() {
    ...
    final newShop = Shop(
      ...
      latitude:
          47.9200, // Default coordinates - бодит координат ашиглах хэрэгтэй
      longitude: 106.9200,
      ...
      email: _shopEmailController.text.trim().isNotEmpty
          ...
          : null,
      registrationNumber:
          _shopRegistrationNumberController.text.trim().isNotEmpty
              ? _shopRegistrationNumberController.text.trim()
              : null,
      status: 'active',
      orders: [],
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  helperText:
                      'opendatalab.mn-аас мэдээлэл авах эсвэл гараар оруулах',
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  helperText:
                      'API-аас ирсэн эсвэл гараар оруулсан байгууллагын нэр',
                ),
                enabled: true,
                validator: (value) {
                    ...
                    children: [
                      ...
                      if (_shopRegistrationInfo!['type'] != null) ...[
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                (_shopRegistrationInfo!['type'] == 'Дэлгүүр' ||
                                        _shopRegistrationInfo!['type']
                                                .toString()
                                                .toLowerCase() ==
                                            'дэлгүүр')
                            ...
                            border: Border.all(
                              color: (_shopRegistrationInfo!['type'] ==
                                          'Дэлгүүр' ||
                                      _shopRegistrationInfo!['type']
                                              .toString()
                                              .toLowerCase() ==
                      ...
                      const SizedBox(height: 8),
                      Text(
                          'Бүртгэлийн дугаар: ${_shopRegistrationInfo!['registrationNumber'] ?? 'N/A'}'),
                      const SizedBox(height: 4),
                      Text(
                          'Хаяг: ${_shopRegistrationInfo!['address'] ?? 'N/A'}'),
                      const SizedBox(height: 4),
